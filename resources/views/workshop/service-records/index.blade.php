    ...
    <div class="max-w-6xl mx-auto px-4 py-8">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
            <div>
                ...
                <p class="text-sm text-zinc-500 mt-0.5">Riwayat seluruh servis yang dicatat oleh bengkel Anda</p>
            </div>
                ...
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr class="border-b border-[#2E3030] bg-[#1d1f1f]">
                            ...
                            <th class="px-6 py-4 text-xs font-semibold uppercase tracking-wider text-zinc-400">Jenis Servis</th>
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="px-6 py-12 text-center">
                                    ...
                                    <p class="text-zinc-400 text-sm font-semibold">Belum Ada Record Servis</p>
                                    <p class="text-zinc-650 text-xs mt-1">Scan QR Code kendaraan untuk mulai mencatat servis.</p>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
