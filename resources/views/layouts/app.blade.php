...
<head>
    ...
    <meta name="description"
        content="{{ $metaDescription ?? 'Maintify - Platform Digital Histori Service Kendaraan Motor berbasis QR Code' }}">
                ...
                @auth
                    ...
                    @if($userRole === 'vehicle_owner')
                        ...
                        <div class="sidebar-nav-section">
                            ...
                            <a href="{{ route('vehicles.index') }}" id="nav-vehicles"
                            ...
                            <a href="{{ $firstVehicle ? route('vehicles.qr.show', $firstVehicle) : route('vehicles.index') }}"
                                id="nav-qr" class="sidebar-nav-item {{ request()->routeIs('vehicles.qr*') ? 'active' : '' }}">
                                <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8"
                                        d="M3 3h7v7H3zM14 3h7v7h-7zM3 14h7v7H3z" />
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8"
                                        d="M14 14h3v3m0 4h3m-3 0v-4" />
                                </svg>
                                <span>QR Code</span>
                            </a>

                            <a href="{{ $serviceHistoryUrl }}" id="nav-service"
                            ...
                            <a href="{{ route('workshops.nearby') }}" id="nav-workshop"
                    ...
                    @elseif($userRole === 'workshop' || $userRole === 'workshop_staff')
                        ...
                        <div class="sidebar-nav-section">
                            ...
                            <a href="{{ route('workshop.scan') }}" id="nav-scan"
                                ...
                                <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8"
                                        d="M12 4v1m6 11h2m-6 0h-2v4m0-11v3m0 0h.01M12 12h4.01M16 20h4M4 12h4m12 0h.01M5 8H3a2 2 0 00-2 2v6a2 2 0 002 2h2m2-12V4a2 2 0 012-2h4a2 2 0 012 2v1" />
                                </svg>
                                <span>Scan QR</span>
                            </a>
                            ...
                            <a href="{{ route('workshop.service-records.index') }}" id="nav-ws-service"
                                class="sidebar-nav-item {{ request()->routeIs('workshop.service-records.*') ? 'active' : '' }}">
                                <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8"
                ...
                <div class="sidebar-footer">
                    <div class="flex items-center gap-3">
                        ...
                        <div class="flex-1 min-w-0">
                            <p
                                style="font-size:13px;font-weight:600;color:#F4F4F5;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">
                                {{ Auth::user()->name }}
                            </p>
                            <p
                                style="font-size:11px;color:#71717A;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">
                                {{ Auth::user()->email }}
                            </p>
                        </div>
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button type="submit" id="sidebar-logout-btn" class="btn-icon btn-ghost" title="Logout"
                                style="padding:6px;">
        ...
        <div class="main-wrapper">
            ...
            <header class="topbar" id="topbar" role="banner">
                <div class="topbar-left">
                    {{-- Hamburger (Mobile) --}}
                    <button id="sidebar-toggle" class="btn-icon btn-ghost lg:hidden" onclick="toggleSidebar()"
                ...
                <div class="topbar-right">
                    ...
                    @auth
                        <div class="relative" x-data="{ open: false }">
                            <button @click="open = !open" id="topbar-user-menu"
                                class="flex items-center gap-2 px-2 py-1.5 rounded-lg transition-colors"
                                style="color:#A1A1AA;" :style="open ? 'background-color:#2A2D2D;color:#F4F4F5;' : ''"
                            ...
                            <div x-show="open" @click.away="open = false"
                                ...
                                <a href="{{ route('profile.edit') }}" id="topbar-profile-link"
            ...
            @auth
                ...
                <nav class="bottom-nav" id="bottom-nav" role="navigation" aria-label="Bottom Navigation">
                    ...
                    @if($userRoleNav === 'user' || $userRoleNav === 'vehicle_owner')
                        <a href="{{ route('dashboard') }}" id="bottom-nav-home"
                            class="bottom-nav-item {{ request()->routeIs('dashboard') ? 'active' : '' }}" aria-label="Beranda">
                            <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8"
                                    d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                            </svg>
                        ...
                        <a href="{{ route('vehicles.index') }}" id="bottom-nav-vehicle"
                        ...
                        <a href="{{ $firstVehicle ? route('vehicles.qr.show', $firstVehicle) : route('vehicles.index') }}"
                            id="bottom-nav-qr" class="bottom-nav-item {{ request()->routeIs('vehicles.qr*') ? 'active' : '' }}"
                            aria-label="QR Code">
                            <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8"
                                    d="M3 3h7v7H3zM14 3h7v7h-7zM3 14h7v7H3z" />
                        ...
                        <a href="{{ $serviceHistoryUrl }}" id="bottom-nav-service"
                        ...
                        <a href="{{ route('profile.edit') }}" id="bottom-nav-profile"
                            class="bottom-nav-item {{ request()->routeIs('profile*') ? 'active' : '' }}" aria-label="Profile">
                            <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8"
                                    d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                            </svg>
