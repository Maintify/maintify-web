            ...
            <div class="main-wrapper">
                ...
                <header class="topbar" id="topbar" role="banner">
                    ...
                    <div class="topbar-right">
                        {{-- Notifications --}}
                        <button id="topbar-notifications" class="btn-icon btn-ghost" title="Notifications" aria-label="Notifications">
