    ...
    <div class="auth-container" style="min-height:100vh;display:flex;align-items:stretch;">
        ...
        <div class="hidden lg:flex flex-col justify-between auth-left-panel" aria-hidden="true"
            ...
            <div style="position:absolute;inset:0;pointer-events:none;">
                <div
                    style="position:absolute;top:-100px;right:-100px;width:400px;height:400px;border-radius:50%;background:radial-gradient(circle,rgba(255,255,255,0.04) 0%,transparent 70%);">
                </div>
                <div
                    style="position:absolute;bottom:-80px;left:-80px;width:300px;height:300px;border-radius:50%;background:radial-gradient(circle,rgba(255,255,255,0.03) 0%,transparent 70%);">
                </div>
            </div>
            ...
            <div style="display:flex;align-items:center;position:relative;z-index:1;">
                <a href="/" class="flex items-center">
                    <img src="{{ asset('images/logo.png') }}" alt="Maintify"
            ...
            <div style="position:relative;z-index:1;">
                ...
                <div style="display:flex;flex-wrap:wrap;gap:8px;">
                    @foreach([
                        ...
                        <span
                            style="display:inline-flex;align-items:center;gap:6px;padding:6px 12px;background:rgba(255,255,255,0.1);border:1px solid rgba(255,255,255,0.15);border-radius:100px;font-size:12px;font-weight:500;color:rgba(255,255,255,0.9);backdrop-filter:blur(8px);">
            ...
            <div
                style="position:relative;z-index:1;padding:20px;background:rgba(255,255,255,0.06);border:1px solid rgba(255,255,255,0.1);border-radius:16px;">
        ...
        ======================== --}}
        <div
            style="flex:1;display:flex;align-items:center;justify-content:center;padding:24px;background:linear-gradient(135deg,#121414 0%,#1a1010 100%);">
